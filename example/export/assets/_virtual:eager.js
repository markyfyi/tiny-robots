...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t0 = claim_text(h3_nodes, "eager prefetch");
...
class Eager extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { wasPrefetched: 0, fetching: 1 });
	}
}var eager$1=/*#__PURE__*/Object.freeze({__proto__:null,'default': Eager,eager: eager,prefetch: prefetch});// @start: generated by hyperlab
...
// @end
export{eager$1 as page,routeProps,start};